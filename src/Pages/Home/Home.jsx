    ...
    return (
        <div className='main-container mt-20 font-montserrat'>
            ...
            <div className="home-top flex justify-between">
                ...
                <div className="home-top-right flex gap-2 items-center">
            ...
            {/* ::::::::: HOME MIDDLE SECTION ::::::::: */}
            <div className="home-middle-section grid grid-cols-4 gap-8 my-12 items-end">


                <div className='quiz-div col-span-1 flex flex-col gap-4'>
                    <Link className=' flex gap-2 items-center text-3xl bg-white rounded-full py-5 px-7 w-fit'><BsArrowRight /> <span className='font-medium'>Start The Quiz!</span></Link>
                ...
                <div className='middle-div col-span-2 bg-white rounded-3xl'>
                    <div className='p-5 flex flex-col gap-8'>
                        ...
                        <div>
                            <h1 className='text-3xl'>Recieve daily packs personalized to your <span className='font-semibold'>unique health needs</span></h1>
                        </div>
                    </div>
                ...
                <div className='pills-div p-8 rounded-3xl bg-[#D9EAFD] col-span-1 h-fit'>
                    <div className='flex justify-between'>
            ...
            {/* ::::::::: HOME BOTTOM SECTION ::::::::: */}
            <div className='home-bottom-section grid grid-cols-2 gap-8 my-8'>
                <div className='boottom-left-section bg-white p-8 rounded-3xl'>
                    <div className='top-section flex gap-6 justify-between items-end'>
                        <p className='text-4xl flex items-end'>Product <br /> Library <BsArrowRightCircleFill /></p>
                        <p>Build your own <br /><span className='font-bold'>personalized monthly pack!</span></p>
                    </div>
                    <div className='bottom-section mt-12'>
                        ...
                        <div className="join join-vertical w-full rounded-none">
                            <div className="collapse collapse-arrow join-item border-b border-base-300">
                                ...
                                <div className="collapse-content pl-20 flex flex-col gap-4">
                ...
                <div className='boottom-right-section bg-[#FFF089] p-8 rounded-3xl'>
                    ...
                    <div className='bottom-right-top flex justify-between items-center'>
                        <h3 className='text-4xl font-medium'>Minerals</h3>
                        <Link className=' flex gap-2 items-center text-xl bg-white rounded-full py-3 px-5 w-fit'><BsArrowRight /> <span className='font-medium'>Explore Library</span></Link>
                    </div>



                    <div className='middle-div bg-white rounded-3xl w-3/5 m-auto my-16'>
                        <div className='p-5 flex flex-col gap-8'>
                            <div className='flex justify-between'>
                                <div className='flex items-center gap-3'>
                            ...
                            <div className='flex justify-between items-center'>
                                ...
                                <h3 className='font-medium text-xl underline flex items-center gap-2'><BsArrowRight /> Start the quiz!</h3>
                            </div>
                        </div>
                        <div className='relative'>
